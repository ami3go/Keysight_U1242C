...
- Response parsing shall strip trailing `
`, `
...
Required repository Markdown files:
...
5. Implement `SerialTransport`.
6. Implement `KeysightU1242C` using transport.
7. Export public API from `src/keysight_u1242c/__init__.py`.
8. Add logging.
9. Add parsing helpers for battery and measurement.
10. Add CSV measurement logging API/helper.
11. Add context manager support.
12. Add deprecated compatibility aliases.
13. Add unit tests with fake serial.
14. Add package import/install tests.
15. Add CSV logger tests.
16. Add examples.
17. Add README and API/logging/production documentation.
18. Add GitHub repository Markdown files: `CHANGELOG.md`, `CONTRIBUTING.md`, and `SUPPORT.md`.
19. Run formatting and tests.
20. Verify editable install with `python -m pip install -e .`.
21. Verify build with `python -m build`.
22. Review final API and repository documentation for production usability.
